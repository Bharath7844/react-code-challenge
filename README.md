...
- do it in a seperate terminal -`json-server` install globally (npm install -g json-sever) and execut command in different terminal json-sever --watch db.json to get started with API's
